...
Element.Methods = {
  ...
  descendants: function(element) {
    return $prototype(element).select("*");
  },
  ...
  identify: function(element) {
    ...
    if (id) return id;
    do { id = 'anonymous_element_' + self.counter++ } while ($prototype(id));
...
/^:((first|last|nth|nth-last|only)(-child|-of-type)|empty|checked|(en|dis)abled|not)(\((.*?)\))?(\b|$|(?=\s|[:+~>]))/,
  ...
  matchElements: function(elements, expression) {
    var matches = $$prototype(expression), h = Selector.handlers;
    h.mark(matches);
...
(function() {
  ...
  if (document.addEventListener) {
    ...
    $prototype("__onDOMContentLoaded").onreadystatechange = function() {
