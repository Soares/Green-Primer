...
function step(cnt) {
	...
	gp.context.clearRect(0, 0, gp.canvas.WIDTH, gp.canvas.HEIGHT);
	drawWorld(world, gp.context);
	setTimeout('step(' + (cnt || 0) + ')', 100);
}
$(function() {
	setupWorld();
...
function createWorld() {
	...
	createGround(world);
	createBox(world, 0, 1024, 10, 250);
	createBox(world, 1024, 1024, 10, 250);
	return world;
}
...
demos.top.initWorld = function(world) {
	demos.top.createBall(world, 1000, 1000, 50, true);
